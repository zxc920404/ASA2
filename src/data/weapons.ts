...
export const WEAPONS: WeaponData[] = [
  ...
  },
  {
    ...
    levelStats: [
      ...
      // Lv4：發射數量 +1（機制提升）
      { damage: 10, range: 150, radius: 50, count: 2, interval: 2.8, duration: 2.2 },
      // Lv5：持續時間延長
      { damage: 10, range: 160, radius: 50, count: 2, interval: 2.8, duration: 2.8 },
      // Lv6：傷害提升
      { damage: 13, range: 160, radius: 55, count: 2, interval: 2.8, duration: 2.8 },
      // Lv7：尋敵範圍擴大，冷卻縮短
      { damage: 13, range: 180, radius: 55, count: 2, interval: 2.4, duration: 2.8 },
      // Lv8：發射數量 +1（機制提升），傷害提升
      { damage: 15, range: 190, radius: 55, count: 3, interval: 2.6, duration: 2.8 },
    ],
  },
];
